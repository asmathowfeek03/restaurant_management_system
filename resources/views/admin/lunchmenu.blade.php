         ...
         <div class="row">
           <div class="col-sm-12">
             ...
             <div class="table-responsive  mt-1">
                              <h1 style="color:blue; margin-bottom:30px; text-align: center; font-weight:bold;font-size:20px">Manage Lunch Menu Items</h1>
                                 <table class="table select-table" >
                                   ...
                                   @foreach($data as $data)
                                     <tr>
                                       <td style="font-size:14px; text-align:center;color:black;">{{$data->ltitle}}</td>
                                       
                                           
                                       <td style="font-size:14px; text-align:center;color:red;font-weight:bold">{{$data->lprice}}</td>
                                     
                                       <td style="font-size:14px; text-align:center;color:black;">{{$data->ldescription}}</td>

                                       <td style="font-size:14px; text-align:center;color:black;"><img src="/lunchimage/{{$data->limage}}"></td>
                                       <td style="font-size:30px; text-align:center;color:black;"><div class="badge badge-opacity-warning" style="width:100px "><a href="{{url('/deletelmenu',$data->id)}}"  style="color:red;font-size:14px;font-weight:bold">DELETE</a></div></td>
                                     
                                       <td style="font-size:30px; text-align:center;color:black;"><div class="badge badge-opacity-success" style="width:100px "><a href="{{url('/updatelview',$data->id)}}" style="color:green;font-size:14px;font-weight:bold">EDIT</a></div></td>
                                    </tr>
                                    @endforeach
                               ...
                               <div class="table-responsive  mt-1">
                                  <form action="{{url('/uploadlunch')}}" method="POST" enctype="multipart/form-data"  style="  text-align: center">
                                    @csrf
                                   
                                    <h1 style="color:blue; margin-bottom:40px; text-align: center; font-weight:bold;font-size:20px">Add New Delights to the Lunch Menu</h1>
                                    
                                    
                                    <div>
                                        <label style="color:black; margin-bottom:30px">Title<label> 
                                            <input style="color:blue; margin-left:90px; width:300px" type="text" name="ltitle" placeholder="Food Name" required>
                                    </div>
                                    <div>
                                        <label style="color:black; margin-bottom:30px">Price<label>
                                            <input style="color:blue; margin-left:85px; width:300px" type="text" name="lprice" placeholder=" Price" required>
                                    </div>
                                    <div>
                                        <label style="color:black; margin-bottom:30px;margin-left:30px">Image<label>
                                            <input style="margin-left:79px " type="file" name="limage"  required>
                                    </div>
                                    <div>
                                        <label style="color:black; margin-bottom:60px">Description<label>
                                            <input style="color:blue; margin-left:40px; width:300px" type="text" name="ldescription" placeholder="Food Description"  required>
                                    </div>
