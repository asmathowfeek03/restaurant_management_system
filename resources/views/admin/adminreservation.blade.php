         ...
         <div class="row">
           <div class="col-sm-12">
             <div class="home-tab">
                             ...
                             <h1 style="color:blue; margin-bottom:30px; text-align: center; font-weight:bold;font-size:20px">Reservations</h1><br><br>
                                 <table class="table select-table" >
                                   <thead>
                                     <tr>
                                       ...
                                       <th style="font-size:15px; text-align:center;color:black;">Phone No</th>
                                       <th style="font-size:15px; text-align:center;color:black;">No of Guest</th>
                                       <th style="font-size:15px; text-align:center;color:black;">Date</th>
                                       <th style="font-size:15px; text-align:center;color:black;">Time</th>
                                       <th style="font-size:15px; text-align:center;color:black;">Message</th>
                                     </tr>
                                   </thead>
                                   <tbody>
                                    @foreach($data as $data)
                                     <tr>
                                       ...
                                       <td style="font-size:14px; text-align:center;color:black;">{{$data->phone}}</td>  
                                       <td style="font-size:14px; text-align:center;color:black;">{{$data->guest}}</td>
                                       <td style="font-size:14px; text-align:center;color:black;">{{$data->date}}</td>
                                       <td style="font-size:14px; text-align:center;color:black;">{{$data->time}}</td>
                                       <td style="font-size:14px; text-align:center;color:black;">{{$data->message}}</td>
