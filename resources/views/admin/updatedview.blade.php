           ...
           <div class="col-sm-12">
             <div class="home-tab">
                             ...
                             <div class="table-responsive  mt-1">
                                  ...
                                  <form action="{{url('/updated', $data->id)}}" method="POST" enctype="multipart/form-data"  style="  text-align: center">
                                    @csrf
                                   
                                    <h1 style="color:blue; margin-bottom:40px; text-align: center; font-weight:bold;font-size:20px">Want to Make Any Changes in Dinner Menu?</h1>
                      

                                    <div>
                                        <label style="color:black; margin-bottom:30px">Title<label> 
                                            <input style="color:blue; margin-left:90px; width:300px" type="text" name="dtitle" value="{{$data->dtitle}}" required>
                                    </div>
                                    <div>
                                        <label style="color:black; margin-bottom:30px">Price<label>
                                            <input style="color:blue; margin-left:85px; width:300px" type="text" name="dprice" value="{{$data->dprice}}" required>
                                    </div>
                                    
                                    <div>
                                        <label style="color:black; margin-bottom:60px">Description<label>
                                            <input style="color:blue; margin-left:40px; width:300px" type="text" name="ddescription" value="{{$data->ddescription}}"  required>
                                    </div>

                                    <div>
                                        <label style="color:black; margin-bottom:30px;padding-right:90px"> Previous Image <label>
                                            <img style="height:300px; padding-left:40px"   src="/dinnerimage/{{$data->dimage}}">
                                
                                    </div>

                                    <div>
                                        <label style="color:black; margin-bottom:30px;margin-left:30px">New Image<label>
                                            <input style="margin-left:79px " type="file" name="dimage" >
                                    </div>
