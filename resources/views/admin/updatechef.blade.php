           ...
           <div class="col-sm-12">
             <div class="home-tab">
                             ...
                             <div class="table-responsive  mt-1">
                                  ...
                                  <form action="{{url('/updatefoodchef', $data->id)}}" method="POST" enctype="multipart/form-data"  style=" text-align: center">
                                    @csrf
                                   
                                    <h1 style="color:blue; margin-bottom:40px; text-align: center; font-weight:bold;font-size:20px">Update Your Chef list</h1>
                                    

                                    <div>
                                        <label style="color:black; margin-bottom:30px">Chef Name<label> 
                                            <input style="color:blue; margin-left:75px; width:300px" type="text" name="name" value="{{$data->name}}" required>
                                    </div>

                                    <div>
                                        <label style="color:black; margin-bottom:30px">Speciality<label>
                                            <input style="color:blue; margin-left:85px; width:300px" type="text" name="speciality" value="{{$data->speciality}}" required>
                                    </div>
                                    

                                    <div>
                                        <label style="color:black; margin-bottom:30px;padding-right:90px"> Previous Image <label>
                                            <img style="height:300px; padding-left:40px" src="/chefimage/{{$data->image}}">
                                
                                    </div>

                                    <div>
                                        <label style="color:black; margin-bottom:30px;margin-left:30px">New Image<label>
                                            <input style="margin-left:79px" type="file" name="image">
                                    </div>
